...
/**
  ...
  */
final class LevelContainer[M, V](using modelClassTag: ClassTag[M], viewClassTag: ClassTag[V])(val size: Int, val entityRepository: EntityMvRepositoryContainer[M, V]):
    /**
